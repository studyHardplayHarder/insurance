...
load data local inpath '/export/data/workspace/10_insurance_full/5_hive_data/mort_10_13.txt' overwrite into table mort_10_13;
...
create table dd_table(
    ...
    row format delimited fields terminated by '\t';
load data local inpath '/export/data/workspace/10_insurance_full/5_hive_data/dd_table.txt' overwrite into table dd_table;
...
create table pre_add_exp_ratio  (
    ...
    row format delimited fields terminated by '\t';
load data local inpath '/export/data/workspace/10_insurance_full/5_hive_data/pre_add_exp_ratio.txt' overwrite into table pre_add_exp_ratio;
...
load data local inpath '/export/data/workspace/10_insurance_full/5_hive_data/prem_std_real.txt' overwrite into table prem_std_real;
...
(
    ...
    row format delimited fields terminated by '\t';
load data local inpath '/export/data/workspace/10_insurance_full/5_hive_data/prem_cv_real.txt' overwrite into table prem_cv_real;
...
load data local inpath '/export/data/workspace/10_insurance_full/5_hive_data/area.txt' overwrite into table area;
...
load data local inpath '/export/data/workspace/10_insurance_full/5_hive_data/policy_client.txt' overwrite into table policy_client;
...
load data local inpath '/export/data/workspace/10_insurance_full/5_hive_data/policy_benefit.txt' overwrite into table policy_benefit;
...
(
    ...
    row format delimited fields terminated by '\t';
load data local inpath '/export/data/workspace/10_insurance_full/5_hive_data/claim_info.txt' overwrite into table claim_info;
...
(
    ...
    row format delimited fields terminated by '\t';
load data local inpath '/export/data/workspace/10_insurance_full/5_hive_data/policy_surrender.txt' overwrite into table policy_surrender;
